              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-yellow-600">
                    ${overdueLoans.reduce((sum, loan) => sum + (loan.fine || 0), 0)}
                  </p>
                </div>
        ...
        <Dialog open={showReturnDialog} onOpenChange={setShowReturnDialog}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                ¿Confirmas que el libro "{selectedLoan?.bookTitle}" ha sido devuelto por {selectedLoan?.userName}?
              </DialogDescription>
            </DialogHeader>
            {selectedLoan?.fine && (
              <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-lg">
                <p className="text-sm font-medium text-yellow-800">
                  Este préstamo tiene una multa pendiente de ${selectedLoan.fine}
                </p>
                <p className="text-xs text-yellow-700 mt-1">
                  Asegúrate de cobrar la multa antes de completar la devolución
                </p>
              </div>
            )}
            <DialogFooter>
              ...
              <Button onClick={handleConfirmReturn} className="bg-green-600 hover:bg-green-700">
